...
__interrupt void ADC_ISR(void){
    switch(__even_in_range(ADCIV,ADCIV_ADCIFG)){
        ...
        case ADCIV_ADCIFG: // ADCMEM0 memory register with the conversion result
            ADCCTL0 &= ~ADCENC;
            switch (ADC_Channel){
                case CHANNEL_2: // Interrupt runs for channel 2 to get ADC values
                     ...
                     break;
                case CHANNEL_3: // Interrupt runs for channel 3 to get ADC values
                    ...
                    break;
                case CHANNEL_5: // Interrupt runs for channel 5 to get ADC values
                    ADC_Thumb = ADCMEM0;
