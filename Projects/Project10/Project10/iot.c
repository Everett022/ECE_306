...
//Code that will run at compile time to reset the password
...
//Function that also runs at compile time to reset the IOT command inputs
...
//Function that converts the time to a value for later use
    ...
    switch(iot_status){
        ...
        case IOT_READY:
            ...
            if(ok_received){
                ...
                strcpy(display_line[1], "IOT READY!");
            ...
            break;
        case IOT_DISPLAY:
            if(configured_flag && sw2_position){
                configured_flag = 0;
                sw1_position = 0;
                ok_received = 0;
        ...
        case IP_ADDY:
            ...
            if(ssid_string_flag){
                ...
                display_line[1][3] = ssid_string[0];
                display_line[1][4] = ssid_string[1];
                display_line[1][5] = ssid_string[2];
                display_line[1][6] = ssid_string[3];
                display_line[1][7] = ssid_string[4];
                display_line[1][8] = ssid_string[5];
                display_line[1][9] = ssid_string[6];
                display_line[2][0] = ssid_string[7];
                display_line[2][1] = ssid_string[8];
                display_line[2][2] = ssid_string[9];
                display_line[2][3] = ssid_string[10];
